...
procedureRegistrationRouter.put("/approve/:id", [authMiddleware(ADMIN), approveValidation, validationMiddleware], procedureRegistrationController.approveProcedureRegistration);
